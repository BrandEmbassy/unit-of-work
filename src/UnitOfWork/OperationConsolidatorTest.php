...
class OperationConsolidatorTest extends TestCase
{
    public function testShouldReduce(): void
    {
        ...
        $result = $reducer->consolidate($operations, new OperationConsolidationMode(false, false, false));
    ...
    {
        $reducer = new OperationConsolidator();
        Assert::assertEquals($data, $reducer->consolidate($data, new OperationConsolidationMode(false, false, false)));
    }
